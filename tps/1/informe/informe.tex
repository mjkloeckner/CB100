...
Se declara la función \code{vectorExportToFile} la cual recibe como
...
\linebreak\code{vectorExportToFile}
...
\subsubsection{Función \code{vectorExportToFile}}

La función \code{vectorExportToFile} recibe como argumento un vector, una
